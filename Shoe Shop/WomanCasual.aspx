<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="WomanCasual.aspx.cs" Inherits="WomanCasual" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
<title>Woman Casual Shoes</title>
<link href="css/Custome.css" rel="stylesheet" type="text/css" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">

<div class="container">
  <h2>Woman Casual Shoes</h2>  

    <div class="panel panel-primary">
      <div class="panel-heading">Woman Casual Shoes</div>
