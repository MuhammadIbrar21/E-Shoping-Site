<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="KidsGirls.aspx.cs" Inherits="KidsGirls" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
<title>Kids Girls Shoes</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">


<div class="container">
  <h2>Kids Girls Shoes</h2>  

    <div class="panel panel-primary">
      <div class="panel-heading">Kids Girls Shoes</div>
