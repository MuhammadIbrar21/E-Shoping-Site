<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="ManCasual.aspx.cs" Inherits="ManCasual" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
<title>Man Casual Shoes</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">

<div class="container">
  <h2>Man Casual Shoes</h2>  

    <div class="panel panel-primary">
      <div class="panel-heading">Men Shoes</div>
