...
public partial class AddBrand : System.Web.UI.Page
{
    ...
    {
        using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["TheShoeShopDB"].ConnectionString))
        {
    ...
    {
        //SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["TheShoeShopDB"].ConnectionString);
